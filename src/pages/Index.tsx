    ...
    <div className="min-h-screen bg-background">
      ...
      <section id="eventos" className="container mx-auto px-4 py-8">
        <div className="text-center mb-8">
          <h2 className="text-3xl font-black text-foreground mb-4">Eventos Disponíveis</h2>
          <p className="text-muted-foreground font-medium">Encontre o evento perfeito para você</p>
        </div>
